...
const PRODUCTS = [
  {
    ...
    subtitle: "Agua alcalina pura, directo de su grifo",
    description:
  ...
  {
    title: "Suavizador de Agua",
    subtitle: "Adiós al sarro, bienvenida la suavidad",
    description:
  ...
  {
    title: "Válvula Water Specialist",
    subtitle: "Precisión con certificación NSF",
    description:
    ...
    >
      <div className="section">
        <div className="max-w-7xl mx-auto container-px">
          {/* Section Header */}
          <div className="text-center mb-12 products-header">
          ...
          <div className="products-grid grid grid-cols-1 lg:grid-cols-3 gap-6">
            {PRODUCTS.map((product, idx) => (
              <div
                key={idx}
                className="product-card-anim card-clean flex flex-col overflow-hidden"
              >
                {/* Image */}
                {product.image ? (
                  ...
                  <div className="relative w-full aspect-[4/3] overflow-hidden bg-gradient-to-br from-[#EFF6FF] to-[#E0F7FA] flex items-center justify-center">
                    <div className="text-center px-6">
                      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-white border border-[#E0F7FA] flex items-center justify-center">
                        <svg
                          width="28"
                          height="28"
                          viewBox="0 0 24 24"
                      ...
                      <p className="text-sm text-[#00B4D8] font-semibold font-[var(--font-body)]">
                        NSF Certified
                      </p>
                    </div>
                  </div>
                ...
                <div className="p-6 flex flex-col flex-1">
                  <span className="text-xs text-[#00B4D8] font-semibold tracking-wider uppercase mb-1 font-[var(--font-body)]">
                    {product.subtitle}
                  </span>
                  <h3 className="heading-h3 text-xl text-[#111827] mb-3">
                    {product.title}
                  </h3>
                  <p className="text-[#64748B] body-text text-sm leading-relaxed mb-4">
                    {product.description}
                  </p>
                  ...
                  <div className="mt-auto space-y-2">
                    {product.benefits.map((benefit, bIdx) => (
                      <div key={bIdx} className="flex items-start gap-2">
                        ...
                        />
                        <span className="text-sm text-[#64748B] font-[var(--font-body)] leading-snug">
                          {benefit}
                        </span>
                      </div>
                    ))}
      ...
      <WaterWaves fillColor="#FFFFFF" backgroundColor="#F0F8FF" variant="gentle" />
    </section>
  );
}
